      ...
      <div className={containerClass}>
        <div className="flex items-center gap-3 pb-6">
          <a
            ...
            className="inline-flex items-center gap-2 bg-black text-[#f2a547] px-5 py-2.5 rounded-lg text-xs font-semibold hover:bg-black/90 transition-colors"
          >
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4"><path d="M17.523 2.27a.4.4 0 0 0-.467.063L3.774 11.963a.398.398 0 0 0 0 .074l13.282 9.63a.4.4 0 0 0 .467.063l3.852-2.013a.398.398 0 0 0 .225-.36V4.643a.398.398 0 0 0-.225-.36L17.523 2.27ZM13.6 12 4.853 3.253l12.27 6.413L13.6 12Zm0 0 3.523 2.334L4.853 20.747 13.6 12Z"/></svg>
