...
export default function AIArticleGeneration() {
  ...
  return (
    <div ref={scrollContainerRef} className="h-screen overflow-y-auto bg-white flex flex-col">
      ...
      <header 
        className={`fixed top-0 left-0 right-0 z-50 w-full bg-black/90 backdrop-blur-sm transition-all duration-300 ease-out ${isHeaderHidden ? '-translate-y-full opacity-0' : 'translate-y-0 opacity-100'}`}
      >
      ...
      <div className={`sticky z-40 bg-black/90 backdrop-blur-sm border-b border-white/10 transition-[top] duration-300 ease-out ${isHeaderHidden ? 'top-0' : 'top-16'}`}>
      ...
      <section className="bg-white relative overflow-hidden" style={{ minHeight: isMobile ? '420px' : '520px' }}>
        ...
        {iconPositions.map((pos, index) => {
          ...
          const iconData = aiIcons[index % aiIcons.length];
          ...
          return (
            <div
              key={index}
              className={`absolute shadow-lg overflow-hidden bg-gradient-to-br ${iconData.gradient} flex items-center justify-center`}
              style={style}
            >
        ...
        {/* Arcana Mace logo - centered */}
        <div 
          className="absolute flex flex-col items-center"
          style={{ top: isMobile ? 220 : 320, left: '50%', transform: 'translateX(-50%)' }}
        >
          <div 
      ...
      <section className="pb-20">
        <div className="max-w-[980px] mx-auto px-4 md:px-6">
          <p className="text-xl md:text-2xl text-[#1d1d1f] leading-relaxed text-center max-w-4xl mx-auto">
            Creating compelling content has never been faster. Our AI-powered article generator 
            transforms your ideas into publication-ready articles in seconds. Choose your tone, 
            customize your style, and let artificial intelligence handle the heavy lifting — 
            while you focus on what matters most: your message.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[980px] mx-auto px-4 md:px-6">
          <h2 className="text-4xl md:text-5xl font-semibold text-[#1d1d1f] mb-16">
            ...
            <span className="text-[#86868b]">Three steps to publication.</span>
          </h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            {/* Step 1 */}
            <div className="text-center">
              <div className="w-16 h-16 md:w-20 md:h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center shadow-lg">
                <span className="text-2xl md:text-3xl font-bold text-white">1</span>
              </div>
              <h3 className="text-xl md:text-2xl font-semibold text-[#1d1d1f] mb-3">Choose Your Topic</h3>
              <p className="text-[#86868b] text-base leading-relaxed">
                Browse trending headlines or enter your own custom topic. Our AI understands context and creates relevant content.
              </p>
            </div>
            
            {/* Step 2 */}
            <div className="text-center">
              <div className="w-16 h-16 md:w-20 md:h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center shadow-lg">
                <span className="text-2xl md:text-3xl font-bold text-white">2</span>
              </div>
              <h3 className="text-xl md:text-2xl font-semibold text-[#1d1d1f] mb-3">Generate & Refine</h3>
              <p className="text-[#86868b] text-base leading-relaxed">
                Select your preferred tone and click generate. Review, edit, and perfect the content using our built-in editor.
              </p>
            </div>
            
            {/* Step 3 */}
            <div className="text-center">
              <div className="w-16 h-16 md:w-20 md:h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-green-500 to-emerald-500 flex items-center justify-center shadow-lg">
                <span className="text-2xl md:text-3xl font-bold text-white">3</span>
              </div>
              <h3 className="text-xl md:text-2xl font-semibold text-[#1d1d1f] mb-3">Publish Anywhere</h3>
              <p className="text-[#86868b] text-base leading-relaxed">
                Send to your WordPress site, submit to premium outlets, or save as a draft. The choice is yours.
              </p>
            </div>
          </div>
        </div>
            ...
            {[
              {
                ...
                answer: "Our AI analyzes your chosen topic or headline and generates a complete article of approximately 700 words. It creates human-quality content without robotic phrases or AI clichés, matching your selected tone and style preferences."
              },
              {
                question: "What writing tones are available?",
                answer: "We offer five distinct tones: Neutral (balanced reporting), Professional (formal and authoritative), Casual (friendly and conversational), Enthusiastic (high-energy and exciting), and Informative (deeply educational). Choose the one that best matches your brand voice."
              },
              {
                question: "Can I edit the AI-generated content?",
                answer: "Absolutely. Every generated article opens in our rich text editor where you can modify text, adjust formatting, add your own insights, and ensure the content perfectly matches your vision before publishing."
              },
              {
                question: "Where can I publish AI articles?",
                answer: "You can publish directly to your connected WordPress sites, submit to premium outlets in our media network, or save articles as drafts for later. The full Arcana Mace publishing ecosystem is available."
              },
              {
                question: "Is the generated content original?",
                answer: "Yes. Our AI creates completely original content with less than 50% similarity to any source material. Each article has a unique structure and narrative, ready for publication without plagiarism concerns."
              },
            ].map((faq, index) => (
