    ...
    <section className="bg-black text-white overflow-hidden">
      <div className="max-w-[980px] mx-auto px-4 md:px-6">
        ...
        <AnimatedSection delay={200}>
          <p className="text-lg md:text-xl text-white/70 max-w-2xl mb-10">{description}</p>
        </AnimatedSection>
      </div>
          ...
          <div className="max-w-[980px] mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                ...
                { icon: Radio, title: 'Speed that saves lives.', desc: 'Threats don\'t wait. Precision AI engine processes extensive amounts of data to surface what matters before it escalates.', link: '#engine', linkText: 'Learn more about the engine' },
              ].map((item) => (
