  ...
  return (
    <section>
          ...
          <div className="min-h-[200px] flex flex-col justify-center items-center text-center">
            <div className="text-3xl md:text-4xl lg:text-5xl font-semibold text-[#7f1d1d] leading-snug">
              ...
              <p className="mb-2 flex items-center justify-center gap-3 flex-wrap">
                ...
                >
                  GO <CornerDownRight className="inline w-5 h-5 ml-1" />
                </button>
        ...
        <div
          id="ai-section"
          ref={aiSectionRef}
          className="bg-black rounded-none px-4 md:px-6 lg:px-0 py-10 md:py-16 lg:py-20 text-center overflow-hidden"
        >
    ...
    <div ref={scrollContainerRef} className="h-screen overflow-y-auto bg-white flex flex-col">
      ...
      <section className="pt-28 md:pt-32 bg-black">
        <div className="max-w-[980px] mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-xl md:text-2xl text-[#a1a1a6] max-w-3xl mx-auto mb-8 leading-tight md:leading-relaxed">
            Discover an incredibly diverse network of media outlets worldwide. 
            Publish your content where it matters most. 
            And enjoy it all on a platform designed for brands and publishers.
          </p>
      ...
      <section className="py-24 md:py-32 bg-black">
        <div className="max-w-[980px] mx-auto px-4 md:px-6">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-white text-center mb-12">
            More to explore.
          </h2>
