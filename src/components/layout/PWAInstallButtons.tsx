    ...
    <div className="w-full">
      <div className="max-w-[980px] mx-auto px-0 md:px-6 pt-6">
        ...
        <button
          ...
          className="w-full md:w-auto inline-flex items-center justify-center gap-2 bg-[#1d1d1f] text-[#f2a547] px-5 py-3 rounded-none text-sm font-semibold hover:text-white transition-colors"
        >
