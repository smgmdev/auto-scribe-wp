...
export function QuickNavBanner({ inDashboard = false }: { inDashboard?: boolean }) {
  ...
  return (
    <div className={`${inDashboard ? 'hidden lg:block fixed top-0 left-64 right-0' : 'fixed top-0 left-0 right-0'} z-50 bg-black text-white text-[10px] md:text-xs py-1.5 px-4 md:px-6 tracking-tight`}>
