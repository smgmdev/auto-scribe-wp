          ...
          <div className="relative h-56 md:h-72 mt-12 max-w-2xl mx-auto">
            ...
            {mediaSites.slice(0, 3).length > 0 ? (
              <>
                ...
                <div className="absolute left-16 md:left-24 top-16 md:top-14 w-20 h-20 md:w-28 md:h-28 rounded-full bg-gradient-to-b from-[#3a3a3c] to-[#2a2a2c] border-2 border-[#4a4a4c] flex items-center justify-center overflow-hidden shadow-[0_0_30px_rgba(191,90,242,0.3),inset_0_0_20px_rgba(191,90,242,0.4)]">
                ...
                {/* Center icon - biggest */}
                <div className="absolute left-1/2 -translate-x-1/2 bottom-0 w-40 h-40 md:w-56 md:h-56 rounded-full bg-gradient-to-b from-[#3a3a3c] to-[#2a2a2c] border-2 border-[#6a4a7c] flex items-center justify-center overflow-hidden shadow-[0_0_60px_rgba(191,90,242,0.5),inset_0_0_40px_rgba(191,90,242,0.5)] z-10">
                ...
                <div className="absolute right-16 md:right-24 top-0 w-20 h-20 md:w-28 md:h-28 rounded-full bg-gradient-to-b from-[#3a3a3c] to-[#2a2a2c] border-2 border-[#4a4a4c] flex items-center justify-center overflow-hidden shadow-[0_0_30px_rgba(191,90,242,0.3),inset_0_0_20px_rgba(191,90,242,0.4)]">
              ...
              <>
                {/* Left icon - positioned closer to center */}
                <div className="absolute left-16 md:left-24 top-16 md:top-14 w-20 h-20 md:w-28 md:h-28 rounded-full bg-gradient-to-b from-[#3a3a3c] to-[#2a2a2c] border-2 border-[#4a4a4c] flex items-center justify-center shadow-[0_0_30px_rgba(191,90,242,0.3),inset_0_0_20px_rgba(191,90,242,0.4)]">
                  <Newspaper className="w-10 h-10 md:w-14 md:h-14 text-[#2997ff]" />
                </div>
                {/* Center icon - biggest */}
                <div className="absolute left-1/2 -translate-x-1/2 bottom-0 w-40 h-40 md:w-56 md:h-56 rounded-full bg-gradient-to-b from-[#3a3a3c] to-[#2a2a2c] border-2 border-[#6a4a7c] flex items-center justify-center shadow-[0_0_60px_rgba(191,90,242,0.5),inset_0_0_40px_rgba(191,90,242,0.5)] z-10">
                  <Building2 className="w-20 h-20 md:w-28 md:h-28 text-[#bf5af2]" />
                </div>
                {/* Right icon - positioned higher */}
                <div className="absolute right-16 md:right-24 top-0 w-20 h-20 md:w-28 md:h-28 rounded-full bg-gradient-to-b from-[#3a3a3c] to-[#2a2a2c] border-2 border-[#4a4a4c] flex items-center justify-center shadow-[0_0_30px_rgba(191,90,242,0.3),inset_0_0_20px_rgba(191,90,242,0.4)]">
                  <TrendingUp className="w-10 h-10 md:w-14 md:h-14 text-[#30d158]" />
                </div>
              </>
            )}
