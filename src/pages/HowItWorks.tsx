...
import { Search, User, Globe, Zap, Shield, Users, FileText, TrendingUp, ExternalLink, Loader2, Newspaper, Building2, PenTool, BarChart3, Send, Clock, CheckCircle2, ArrowUpRight, BookOpen, Library, CornerDownLeft } from 'lucide-react';
          ...
          <div className="min-h-[200px] flex flex-col justify-center items-center text-center">
            <div className="text-3xl md:text-4xl lg:text-5xl font-semibold text-[#7f1d1d] leading-snug">
              ...
              <p className="mb-2 flex items-center justify-center gap-3 flex-wrap">
                ...
                >
                  GO <CornerDownLeft className="inline w-5 h-5 ml-1" />
                </button>
