...
export function MainLayout({
  ...
  return <div className="min-h-screen bg-background">
      ...
      <header className="lg:hidden fixed top-[96px] left-0 right-0 z-50 h-14 bg-sidebar border-b border-sidebar-border flex items-center justify-center px-4">
      ...
      {/* Main Content */}
      <main className={`lg:pl-64 pt-[152px] lg:pt-[56px] h-screen overflow-y-auto flex flex-col ${isDarkFooter ? 'bg-[#1d1d1f]' : ''}`}>
