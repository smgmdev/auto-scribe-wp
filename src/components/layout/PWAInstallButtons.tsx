...
export function PWAInstallButtons() {
  ...
  return (
    <div className="w-full">
      <div className="max-w-[980px] mx-auto px-0 md:px-6 pt-0">
        <div className="flex flex-col md:flex-row items-stretch justify-start gap-0">
          ...
          <button
            ...
            className="w-full md:w-auto inline-flex items-center justify-start md:justify-center gap-2 bg-black text-[#f2a547] border border-black px-5 py-3 rounded-none text-sm font-semibold hover:bg-[#f2a547] hover:text-black hover:border-[#f2a547] transition-colors"
          >
          ...
          {/* Email signup */}
          <form onSubmit={handleSignup} className="flex w-full md:w-auto md:flex-1">
            <input
              type="email"
              ...
              required
              className="flex-1 min-w-0 bg-black text-white border border-black px-4 py-3 rounded-none text-sm placeholder:text-gray-500 focus:outline-none focus:border-[#f2a547]"
            />
            <button
              type="submit"
              disabled={loading}
