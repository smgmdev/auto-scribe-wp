...
const arcanaPrecisionGlobe = '/videos/arcana-precision-globe.mp4';
    ...
    <div ref={scrollContainerRef} className="h-screen overflow-y-auto bg-white flex flex-col">
      ...
      <main className="bg-white text-[#1d1d1f]">
        ...
        <section className="relative overflow-hidden bg-[#1d1d1f] text-white">
          ...
          <div className="max-w-[980px] mx-auto px-4 md:px-6 pt-[180px] pb-24 md:pt-[200px] md:pb-36 text-center relative z-10">
            <AnimatedSection>
        ...
        <section id="media-buying-marketplace" className="bg-black min-h-[auto] md:min-h-screen flex flex-col items-center justify-center px-4 md:px-6 py-10 md:pt-16">
          <AnimatedSection className="text-center flex flex-col items-center">
            ...
            <Button
              ...
              className="rounded-none bg-[#f2a547] text-black border border-[#f2a547] h-12 px-8 text-base font-medium mt-8 transition-all duration-300 ease-out hover:bg-black hover:text-[#f2a547] hover:border-[#f2a547]"
            >
              Learn More
            </Button>
          </AnimatedSection>
        ...
        {/* Mace AI Section */}
        <section className="bg-black min-h-[auto] md:min-h-screen flex flex-col items-center justify-center px-4 md:px-6 py-10 md:py-0">
          <AnimatedSection className="text-center flex flex-col items-center">
            <p className="text-sm font-medium tracking-wider uppercase text-white/40 mb-4">Our Products</p>
        ...
        <section className="bg-black min-h-[auto] md:min-h-screen flex flex-col items-center justify-center px-4 md:px-6 py-10 md:pb-28 md:py-0">
          <AnimatedSection className="text-center flex flex-col items-center">
            <p className="text-sm font-medium tracking-wider uppercase text-white/40 mb-4">Our Products</p>
