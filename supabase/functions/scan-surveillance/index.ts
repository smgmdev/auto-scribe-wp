...
CRITICAL — THREATS & RHETORIC ARE NOT TRADE: Statements, warnings, declarations, or threats (e.g. "Iran says ships are legitimate targets", "North Korea warns of nuclear response", "Russia threatens retaliation") are NOT trade events and NOT attacks. These are political rhetoric — do NOT classify them as trade or missile events. Set origin_country_code and destination_country_code to null for rhetoric/threat/warning headlines. Only classify as "trade" when a PHYSICAL transfer of military equipment actually occurred.
