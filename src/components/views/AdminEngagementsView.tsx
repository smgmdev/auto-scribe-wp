...
export function AdminEngagementsView() {
  ...
  return (
    <div className="animate-fade-in bg-white min-h-[calc(100vh-56px)] lg:min-h-screen -m-4 lg:-m-8 p-4 lg:p-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-0 md:mb-4">
        <div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="grid w-full grid-cols-2 p-0 h-auto rounded-none">
          <TabsTrigger value="active" className="relative py-2.5 flex-1 data-[state=inactive]:bg-black data-[state=inactive]:text-white">
          ...
          <TabsTrigger value="closed" className="relative py-2.5 flex-1 data-[state=inactive]:bg-black data-[state=inactive]:text-white">
        ...
        <TabsContent value="closed" className="mt-0">
          <Tabs value={closedSubTab} onValueChange={setClosedSubTab}>
            <TabsList className="grid w-full grid-cols-2 p-0 h-auto rounded-none">
              <TabsTrigger value="delivered" className="relative py-2.5 flex-1 data-[state=active]:bg-[#f2a547] data-[state=active]:text-black data-[state=inactive]:bg-black data-[state=inactive]:text-white">
              ...
              <TabsTrigger value="cancelled" className="relative py-2.5 flex-1 data-[state=active]:bg-[#f2a547] data-[state=active]:text-black data-[state=inactive]:bg-black data-[state=inactive]:text-white">
