...
function HighlightCard({ icon: Icon, title, description, image, video, customContent, delay = 0 }: {
  ...
  return (
    <div ref={ref} className="group relative overflow-hidden rounded-none bg-[#1d1d1f] transition-all duration-700"
      ...
      <div className="relative px-6 pb-4 -mt-20 z-10">
...
export default function ArcanaIntelligence() {
  ...
  // Scroll‑spy
  useEffect(() => {
    const ids = ['overview', 'capabilities', 'engine', 'global', 'integration', 'learn-more'];
  ...
  return (
    <>
      ...
      <div ref={scrollContainerRef} className="h-screen overflow-y-auto bg-black flex flex-col">
        ...
        {/* ══════════════ AI ENGINE ══════════════ */}
        <section id="engine" className="pt-10 md:pt-14 pb-10 md:pb-14">
          <FeatureSection
            title="AI Engine"
        ...
        {/* ══════════════ GLOBAL COVERAGE ══════════════ */}
        <section id="global" className="pt-10 md:pt-14 pb-10 md:pb-14">
          <FeatureSection
            title="Global Reach"
          ...
          <div className="max-w-[980px] mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                ...
                { icon: Zap, title: 'Speed that saves lives.', desc: 'Threats don\'t wait. Precision AI engine processes extensive amounts of data to surface what matters before it escalates.', link: '/help/arcana-precision#threat-detection', linkText: 'Learn more about the engine' },
              ].map((item) => (
        ...
        {/* ══════════════ CTA BANNER ══════════════ */}
        <section id="learn-more" className="bg-black pt-0 pb-24 md:pb-32 border-t border-white/5">
          <div className="max-w-[980px] mx-auto px-4 md:px-6 text-center">
            <AnimatedSection>
              <h2 className="text-3xl md:text-5xl font-bold text-white tracking-tight mb-4">
                Enhancing defence precision.
              </h2>
