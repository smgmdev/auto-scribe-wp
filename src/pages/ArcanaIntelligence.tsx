          ...
          <div className="max-w-[980px] mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                ...
                { icon: Crosshair, title: 'Speed that saves lives.', desc: 'Threats don\'t wait. Precision AI engine processes extensive amounts of data to surface what matters before it escalates.', link: '#engine', linkText: 'Learn more about the engine' },
              ].map((item) => (
