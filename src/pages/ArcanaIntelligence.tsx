  ...
  return (
    <>
      ...
      <div ref={scrollContainerRef} className="h-screen overflow-y-auto bg-black flex flex-col">
        ...
        {/* ══════════════ VALUES ══════════════ */}
        <section id="integration" className="bg-black pt-10 lg:pt-28 pb-14 lg:pb-28">
          <div className="max-w-[980px] mx-auto px-4 md:px-6">
            <AnimatedSection>
              <h2 className="text-3xl md:text-5xl font-bold text-white tracking-tight mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                ...
                { icon: Zap, title: 'Speed that saves lives and time.', desc: 'Threats don\'t wait. Precision AI engine processes extensive amounts of data to surface what matters before it escalates.', link: '/help/arcana-precision#threat-detection', linkText: 'Learn more about the engine' },
              ].map((item) => (
