        ...
        <section id="capabilities" className="bg-black py-24 md:py-32">
          ...
          <div className="max-w-[1200px] mx-auto px-4 md:px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              ...
              <HighlightCard icon={Brain} title="Black Hole AI" description="AI that learns the global situation autonomously, visualizes information, and provides guidance for defense." image={engineImg} video={engineVideo} delay={150} />
