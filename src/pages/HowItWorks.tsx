    ...
    >
      <div className="max-w-[980px] mx-auto px-4 md:px-6">
        ...
        <div id="global-media-library" ref={globalLibraryRef} className="mt-16 bg-[#1d1d1f] rounded-[40px] px-6 py-10 md:p-16 lg:p-20 text-center overflow-hidden">
          ...
          <div className="relative h-44 md:h-72 mt-12 mx-auto">
            {/* Purple glow effect behind center icon */}
            <div className="absolute left-1/2 -translate-x-1/2 bottom-0 w-36 h-36 md:w-64 md:h-64 rounded-full bg-gradient-to-t from-[#bf5af2]/40 via-[#bf5af2]/20 to-transparent blur-3xl" />
            <div className="absolute left-1/2 -translate-x-1/2 bottom-4 md:bottom-12 w-28 h-28 md:w-52 md:h-52 rounded-full bg-[#bf5af2]/30 blur-2xl" />
            
            {mediaSites.slice(0, 3).length > 0 ? (
              <>
                {/* Left icon */}
                <div className="absolute left-[8%] md:left-24 top-10 md:top-14 w-[18vw] h-[18vw] max-w-[80px] max-h-[80px] md:w-28 md:h-28 rounded-full bg-gradient-to-b from-[#3a3a3c] to-[#2a2a2c] border-2 border-[#4a4a4c] flex items-center justify-center overflow-hidden animate-purple-glow-pulse">
                ...
                {/* Center icon - biggest */}
                <div className="absolute left-1/2 -translate-x-1/2 bottom-0 w-[38vw] h-[38vw] max-w-[160px] max-h-[160px] md:w-56 md:h-56 rounded-full bg-gradient-to-b from-[#3a3a3c] to-[#2a2a2c] border-2 border-[#6a4a7c] flex items-center justify-center overflow-hidden animate-purple-glow-pulse-intense z-10">
                ...
                {/* Right icon */}
                <div className="absolute right-[8%] md:right-24 top-0 w-[18vw] h-[18vw] max-w-[80px] max-h-[80px] md:w-28 md:h-28 rounded-full bg-gradient-to-b from-[#3a3a3c] to-[#2a2a2c] border-2 border-[#4a4a4c] flex items-center justify-center overflow-hidden animate-purple-glow-pulse" style={{ animationDelay: '1s' }}>
              ...
              <>
                {/* Left icon */}
                <div className="absolute left-[8%] md:left-24 top-10 md:top-14 w-[18vw] h-[18vw] max-w-[80px] max-h-[80px] md:w-28 md:h-28 rounded-full bg-gradient-to-b from-[#3a3a3c] to-[#2a2a2c] border-2 border-[#4a4a4c] flex items-center justify-center animate-purple-glow-pulse">
                  <Newspaper className="w-1/2 h-1/2 text-[#2997ff]" />
                  <div className="absolute inset-0 rounded-full pointer-events-none shadow-[inset_0_0_15px_rgba(191,90,242,0.3)]" />
                </div>
                {/* Center icon - biggest */}
                <div className="absolute left-1/2 -translate-x-1/2 bottom-0 w-[38vw] h-[38vw] max-w-[160px] max-h-[160px] md:w-56 md:h-56 rounded-full bg-gradient-to-b from-[#3a3a3c] to-[#2a2a2c] border-2 border-[#6a4a7c] flex items-center justify-center animate-purple-glow-pulse-intense z-10">
                  <Building2 className="w-1/2 h-1/2 text-[#bf5af2]" />
                  <div className="absolute inset-0 rounded-full pointer-events-none shadow-[inset_0_0_25px_rgba(191,90,242,0.4)]" />
                </div>
                {/* Right icon */}
                <div className="absolute right-[8%] md:right-24 top-0 w-[18vw] h-[18vw] max-w-[80px] max-h-[80px] md:w-28 md:h-28 rounded-full bg-gradient-to-b from-[#3a3a3c] to-[#2a2a2c] border-2 border-[#4a4a4c] flex items-center justify-center animate-purple-glow-pulse" style={{ animationDelay: '1s' }}>
                  <TrendingUp className="w-1/2 h-1/2 text-[#30d158]" />
                  <div className="absolute inset-0 rounded-full pointer-events-none shadow-[inset_0_0_15px_rgba(191,90,242,0.3)]" />
                </div>
              </>
