...
export function MainLayout({
  ...
  return <div className="min-h-screen bg-background">
      ...
      {/* Promo Banner */}
      <div className="fixed top-[28px] left-0 lg:left-64 right-0 z-40 bg-[#1d1d1f] border-b border-white/10 flex items-center h-auto min-h-8 py-3 lg:py-0 lg:h-8 px-4 md:px-6">
        <p className="text-white/80 text-xs flex flex-wrap items-center gap-2 lg:gap-0">
      ...
      <header className="lg:hidden fixed top-[84px] left-0 right-0 z-50 h-14 bg-sidebar border-b border-sidebar-border flex items-center justify-center px-4">
      ...
      {/* Main Content */}
      <main className={`lg:pl-64 pt-[140px] lg:pt-[56px] h-screen overflow-y-auto flex flex-col ${isDarkFooter ? 'bg-[#1d1d1f]' : ''}`}>
