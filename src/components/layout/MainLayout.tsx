...
export function MainLayout({
  ...
  return <div className="min-h-screen bg-background">
      ...
      >
        ...
        {/* Global Footer */}
        <footer className={`border-t px-4 lg:px-8 ${isDarkFooter || isDashboardFooter ? 'bg-black border-white/20' : 'border-border/50'}`} style={{ paddingTop: '1rem', paddingBottom: 'max(8rem, calc(env(safe-area-inset-bottom) + 7rem))' }}>
