  ...
  return (
    ...
    <div ref={scrollContainerRef} className="h-screen overflow-y-auto bg-white flex flex-col">
      ...
      <main className="bg-white text-[#1d1d1f]">
        ...
        <section id="media-buying-marketplace" className="bg-black min-h-[auto] md:min-h-screen flex flex-col items-center justify-center px-4 md:px-6 py-20 md:pt-28">
