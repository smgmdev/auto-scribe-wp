          ...
          <div className="flex-1 relative">
            ...
            {selectedCountry && (
              <div className="absolute top-4 left-4 flex items-start gap-3 z-10">
                {/* Country info popup */}
                <div className="w-80 bg-[#0d1220]/95 backdrop-blur-md border border-white/10 rounded-lg overflow-hidden">
                ...
                {countryMissiles.length > 0 && (() => {
                  ...
                  return (
                    <div className="w-80 bg-[#0d1220]/95 backdrop-blur-md border border-red-500/20 rounded-lg overflow-hidden">
                      <div className="flex items-center justify-between p-3 border-b border-red-500/10">
                        <div className="flex items-center gap-2">
