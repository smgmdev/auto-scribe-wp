    ...
    >
            ...
            <div className="flex-1 flex justify-center md:justify-end p-8 md:py-10 lg:py-12">
              <div className="md:mr-16 text-center md:text-right">
                ...
                <button 
                  ...
                  className="mt-2 px-6 py-2.5 bg-white text-[#1d1d1f] text-sm font-medium hover:bg-white/90 transition-colors"
                >
                  Learn more
                </button>
              </div>
        ...
        >
          ...
          <div className="flex items-center justify-center mt-10">
            <button onClick={() => scrollToSection(aiSectionRef)} className="px-6 py-2.5 bg-white text-[#1d1d1f] text-sm font-medium hover:bg-white/90 transition-colors inline-flex items-center gap-2">
