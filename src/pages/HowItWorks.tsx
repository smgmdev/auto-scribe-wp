          ...
          <div className="relative h-56 md:h-72 mt-12 max-w-2xl mx-auto">
            ...
            {mediaSites.slice(0, 3).length > 0 ? (
              <>
                ...
                {/* Center icon - biggest */}
                <div className="absolute left-1/2 -translate-x-1/2 bottom-0 w-40 h-40 md:w-56 md:h-56 rounded-full bg-gradient-to-b from-[#3a3a3c] to-[#2a2a2c] border-2 border-[#6a4a7c] flex items-center justify-center overflow-hidden animate-purple-glow-pulse-intense animate-float-2 z-10">
              ...
              <>
                ...
                {/* Center icon - biggest */}
                <div className="absolute left-1/2 -translate-x-1/2 bottom-0 w-40 h-40 md:w-56 md:h-56 rounded-full bg-gradient-to-b from-[#3a3a3c] to-[#2a2a2c] border-2 border-[#6a4a7c] flex items-center justify-center animate-purple-glow-pulse-intense animate-float-2 z-10">
                  <Building2 className="w-20 h-20 md:w-28 md:h-28 text-[#bf5af2]" />
                  {/* Inner glow overlay */}
                  <div className="absolute inset-0 rounded-full pointer-events-none shadow-[inset_0_0_25px_rgba(191,90,242,0.4)]" />
                </div>
