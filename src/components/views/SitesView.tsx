            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 pr-10 h-11 text-xs md:text-sm placeholder:text-xs md:placeholder:text-sm"
                />
                {wpSearchQuery && (
                  <Button
                    variant="ghost"
              ...
              <div ref={searchRef} className="relative w-full">
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="w-full pl-10 h-11 text-xs md:text-sm placeholder:text-xs md:placeholder:text-sm"
                  />
                  {searchQuery && (
                    <Button
                      variant="ghost"
