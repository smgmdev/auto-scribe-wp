    ...
    const fetchCountryMissiles = async () => {
      ...
      if (data) {
        ...
        const filtered = data.filter(m => {
          ...
          const analyticalPatterns = ['depletes', 'depleted', 'reserves', 'stockpile', 'running out', 'running low', 'cost of', 'costs of', 'spending on', 'impact on', 'effect on', 'consequences of', 'toll of', 'analysis:', 'opinion:', 'editorial:', 'commentary:', 'lessons from', 'warns about', 'warns of', 'prepares for', 'plans to', 'threatens to', 'vows to', 'vows no', 'vows not', 'vows never', 'vows revenge', 'vows retaliation', 'vowed', 'pledges to', 'pledged to', 'promises to', 'promised to', 'arms race', 'war economy', 'war fatigue', 'no retreat', 'will not back down', 'doubles down', 'stands firm', 'reaffirms', 'signals intent'];
